...
public class Converters implements Iterable<Converter> {
    ...
    public void addDefaultConverters() {
        ...
        addConverters(BooleanConverter.class, ByteConverter.class, CharacterConverter.class,
                DoubleConverter.class, FloatConverter.class, IntegerConverter.class,
                LongConverter.class, ShortConverter.class, StringConverter.class);
