...
<html>
	<head>
		...
		<script src="https://cdn.bootcdn.net/ajax/libs/jquery-validate/1.9.0/localization/messages_cn.js"></script>
		<style type="text/css">
			...
			<form class="form-horizontal col-sm-offset-3 col-md-offset-3" id="login_form">
				...
				<div class="col-sm-12 col-md-12">
					...
					<div class="form-group">
						...
						<hr />
						<a href="https://gitee.com/oauth/authorize?client_id=${requestScope.clientId}&redirect_uri=${requestScope.redirectUrl}&response_type=code" id="register_btn" class="">Login with Gitee</a>
					</div>
					<div class="form-group">
