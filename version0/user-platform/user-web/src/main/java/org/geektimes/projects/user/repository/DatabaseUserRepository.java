...
public class DatabaseUserRepository implements UserRepository {
    ...
    public DatabaseUserRepository() {
        ...
        if (null != classicComponentContext) {
            this.dbConnectionManager = classicComponentContext.getComponent("bean/DBConnectionManager");
        }
    ...
    public boolean save(User user) {
        ...
        int result = executeUpdate(INSERT_USER_DML_SQL, COMMON_EXCEPTION_HANDLER, paramArr);
        return (result == 1);
    }
