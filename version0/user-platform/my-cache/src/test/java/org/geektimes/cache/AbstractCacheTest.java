...
public class AbstractCacheTest {
    ...
    public void testGetConfiguration() {
        CompleteConfiguration<String, Integer> configuration = (CompleteConfiguration<String, Integer>) cache.getConfiguration(Configuration.class);
        ...
        assertThrows(IllegalArgumentException.class, new ThrowingRunnable() {
            ...
            public void run() throws Throwable {
                cache.getConfiguration((Class<Configuration>) clazz);
            }
        });
    }
    ...
    public void testLoadAll() {
        MutableConfiguration<String, Integer> config = new MutableConfiguration<>(this.config)
                .setCacheLoaderFactory(new Factory<CacheLoader<String, Integer>>() {
                    @Override
        ...
        assertFalse(cache.containsKey(key));
        assertEquals("Testing...", exceptionAtomicReference.get().getMessage());
    ...
    public void testInvoke() {
        ...
        Object result = cache.invoke(key, (entry, arguments) -> entry.getKey());
        assertEquals(key, result);
        //test MutableEntry#getValue()
        result = cache.invoke(key, (entry, arguments) -> entry.getValue());
        assertNull(result);
        ...
        assertNull(result);
        assertFalse(cacheName.contains(key));
