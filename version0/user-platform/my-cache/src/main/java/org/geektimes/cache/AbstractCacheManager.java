...
public abstract class AbstractCacheManager implements CacheManager {
    ...
    private void iterateCaches(Iterable<Cache> caches, Consumer<Cache>... cacheOperations) {
        caches.forEach(cache -> Arrays.stream(cacheOperations).forEach(cacheConsumer -> cacheConsumer.accept(cache)));
    ...
    private <V, K, C extends Configuration<K, V>> Cache<K, V> getOrCreateCache(String cacheName, C configuration, boolean created) {
        ...
        return cacheMap.computeIfAbsent(new KeyValueTypePair(configuration.getKeyType(), configuration.getValueType()), keyValueTypePair -> created ? doCreateCache(cacheName, configuration) : null);
    }
